...
##under attack vars for blackboard
static var under_attack : StringName = "under_attack_bool"
static var current_health : StringName = "current_health_float"

## under attack vars
@export var under_attack_bool : bool = false
@export var current_health_amt : float = 100
@export var max_health_var : float = 100
@export var min_health_var : float = 0
